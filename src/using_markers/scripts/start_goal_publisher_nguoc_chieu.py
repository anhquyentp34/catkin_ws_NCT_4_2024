...
class StartGoalPublisher:
    ...
    def publish_markers(self):
        while not rospy.is_shutdown():
            # Robot start point
            robot_start = self.create_marker(-1.0, -5.0, 0.0, "robot_start", 0, Marker.SPHERE, 0.0, 1.0, 0.0, 1.0)
            ...
            # Robot goal point
            robot_goal = self.create_marker(-1.0, 5.0, 0.0, "robot_goal", 1, Marker.SPHERE, 1.0, 0.0, 0.0, 1.0)
